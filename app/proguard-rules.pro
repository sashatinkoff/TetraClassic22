...
# Application classes that will be serialized/deserialized over Gson
-keep class com.isidroid.b21.data.source.remote.request.** { <fields>; }
-keep class com.isidroid.b21.data.source.remote.response.** { <fields>; }
...
-keep class com.isidroid.b21.data.source.remote.apis.** { *; }
